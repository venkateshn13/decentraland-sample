...
class ContentService extends events_1.EventEmitter {
    constructor(catalystServerUrl) {
        super();
        this.client = new dcl_catalyst_client_1.CatalystClient({ catalystUrl: catalystServerUrl });
    }
    /**
    ...
    async fetchEntity(coordinates) {
        ...
        try {
            const entities = await this.client.fetchEntitiesByPointers(dcl_catalyst_commons_1.EntityType.SCENE, [pointer]);
