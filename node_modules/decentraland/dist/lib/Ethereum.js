...
exports.Ethereum = exports.NETWORKS = void 0;
...
const providerInstance = new eth_connect_1.providers.HTTPProvider(provider);
const requestManager = new eth_connect_1.RequestManager(providerInstance);
providerInstance.debug = (0, env_1.isDebug)();
