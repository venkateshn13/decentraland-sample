...
import { SHHFilterOptions, Data, Quantity, SHHFilterMessage, SHHPost, FilterChange, TransactionReceipt, Tag, BlockObject, TransactionObject, TransactionCallOptions, TransactionOptions, Syncing, TxHash, Address, FilterOptions, Transaction } from './Schema';
