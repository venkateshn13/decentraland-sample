...
async function main() {
    ...
    const zipFileName = projectInfo.sceneType === schemas_1.sdk.ProjectType.PORTABLE_EXPERIENCE
...
Please try to remove unneccessary files and/or reduce the files size, you can ignore file adding in .dclignore.`);
        ...
        if (!uuidRegexExp.test(id)) {
            console.error(`The id of the wearable must be an UUID, otherwise the uploading to the builder will fail.`);
        }
    }
